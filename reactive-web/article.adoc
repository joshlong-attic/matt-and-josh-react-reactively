...
----
<1> as before, we're going to make use of our `ProfileService` to do our work
...
<4> this method centralizes all configuration for replies to read requests (for instance, those coming from `GET`)
====
